...
This repo is one of four in the Gryd Lock organization.

| Repo                                          | Role                                                                     |
| ---------------------------------------------- | ------------------------------------------------------------------------- |
| **`grydlock-research`** _(this repo)_         | Threat model, literature review, system design, evaluation methodology  |
| **`grydlock-extension`**                      | Browser extension that warns before signing a risky Stellar transaction |
| **`grydlock-oracle-adapter`**                 | Fetches a 0–100 on-chain risk score for a Stellar address via Soroban    |
| **`grydlock-testkit`**                        | Testnet fixtures and stub scores used to evaluate latency, accuracy, and false-positive rate |
